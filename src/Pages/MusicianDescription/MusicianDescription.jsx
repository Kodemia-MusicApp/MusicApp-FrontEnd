            ...
            <div className="page-container">
                ...
                <div className="group-container">
                    <div className="img-info-container">
                        <img
                            ...
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPmYeGr8-oxntSGzVkT5ra5KUfT65ShaR9CQ&usqp=CAU"
                            alt="img-musician"
                        />
                ...
                <div className="complementary-info">
                    ...
                    <div className="about-group">
                        <p>ACERCA DE</p>
                        <span>
                            Lorem ipsum. Velit ab, voluptatibus quas reiciendis
                            eveniet nam. Doloremque nemo, reiciendis laborum
                            fugit ipsum sint temporibus asperiores modi?
                        </span>
                    </div>
